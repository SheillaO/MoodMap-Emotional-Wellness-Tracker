...
// ========== OPTIONAL: Content Source Filter ==========
// Add this to index.js if you want to let users filter by content type

export function filterBySource(preferredSource = 'all') {
    if (preferredSource === 'all') {
        return catsData
    }
    return catsData.filter(item => item.source === preferredSource)
}

// Usage example:
// const catOnly = filterBySource('cat')
// const snlOnly = filterBySource('snl')
